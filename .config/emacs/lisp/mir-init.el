...
package-vc packages require some extra files, notably the -pkg.el, for
package.el to properly load them.  These files generally don't exist in the
upstream repos and need to be generated by the install process.  Hence this
bootstrap.
"
